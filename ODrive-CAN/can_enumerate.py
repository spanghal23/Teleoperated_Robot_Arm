...
# VVVIMP before anything, make sure you can connection is on:
...
# then within the venv run: 
# python3 can_enumerate.py --channel can0 --save-config

# when you are done, make sure to deactivate interface
