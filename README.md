...
3. Create a virtual enviroment by running this in the cmd (windows): 
          python -m venv venv
...
&[Pose Estimation indexes](Images/_CODE/pose_landmarks_index.png)

0 - nose <br>
1 - left eye (inner) <br>
2 - left eye <br>
3 - left eye (outer) <br>
4 - right eye (inner) <br>
5 - right eye <br>
6 - right eye (outer) <br>
7 - left ear <br>
8 - right ear <br>
9 - mouth (left) <br>
10 - mouth (right) <br>
